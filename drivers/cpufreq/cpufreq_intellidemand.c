...
#define DEF_STEP_UP_EARLY_HISPEED		(1001000)
#define DEF_STEP_UP_INTERIM_HISPEED		(1599000)
...
#define SUP_SLOW_UP_FREQUENCY			(1001000)
#define SUP_HIGH_SLOW_UP_FREQUENCY		(1599000)
...
static int two_phase_freq_array[NR_CPUS] = {[0 ... NR_CPUS-1] = 1599000} ;
