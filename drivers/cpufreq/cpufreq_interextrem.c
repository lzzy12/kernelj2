...
#ifdef CONFIG_ARCH_EXYNOS
	pm_qos_add_notifier(PM_QOS_CPU_FREQ_MIN, &cpufreq_interextrem_cluster1_min_qos_notifier);
	pm_qos_add_notifier(PM_QOS_CPU_FREQ_MAX, &cpufreq_interextrem_cluster1_max_qos_notifier);
#ifdef CONFIG_ARM_EXYNOS_MP_CPUFREQ
	pm_qos_add_notifier(PM_QOS_KFC_FREQ_MIN, &cpufreq_interextrem_cluster0_min_qos_notifier);
	pm_qos_add_notifier(PM_QOS_KFC_FREQ_MAX, &cpufreq_interextrem_cluster0_max_qos_notifier);
#endif
#endif
